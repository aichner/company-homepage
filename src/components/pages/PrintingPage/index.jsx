    ...
    return (
      <div id="printing">
        <MDBContainer className="pt-5">
          ...
          <p className="lead text-danger text-center mb-5 font-weight-bold">
            Schon ab 1 Stück
          </p>
        ...
        <div className="text-center whole py-5">
          <MDBBtn color="red" size="lg" rounded disabled>
          ...
          <MDBRow className="my-5">
            <MDBCol md="6">
              ...
              <h3 className="mt-4 font-weight-bold">
                Wir drucken Ihre Dateien
              </h3>
              <p>
                Durch echtzeit Druckfortschrittanzeige immer auf dem Laufenden
                sein! Verfolgen Sie über unser Portal bequem den Fortschritt
                Ihres Drucks.{" "}
                <strong>Vom Auftragseingang bis zum Versand.</strong>
              </p>
            ...
            <MDBCol md="6">
              ...
              <MDBTimeline>
                <MDBTimelineStep className="normal" color="green">
                  <h4 className="font-weight-bold p-4 mb-0">Auftragseingang</h4>
